...
public class DailyRewardController
{
    ...
    private void SubscribeButtons()
    {
        ...
        _dailyRewardView.GetRewardButton.onClick.AddListener(ActivateAnimationGetRewardButton);
        _dailyRewardView.ResetButton.onClick.AddListener(ResetTimer);
        _dailyRewardView.ResetButton.onClick.AddListener(ActivateAnimationResetButton);
    }
    ...
    private void ActivateAnimationGetRewardButton()
    {
        _dailyRewardView._rectTransformRewardButton.DOShakeAnchorPos(_duration, Stenght);
        _dailyRewardView._rectTransformRewardButton.DOShakeRotation(_duration, Stenght);
    }

    private void ActivateAnimationResetButton()
    {
        _dailyRewardView._rectTransformResetdButton.DOShakeAnchorPos(_duration, Stenght);
        _dailyRewardView._rectTransformResetdButton.DOShakeRotation(_duration, Stenght);
    }
